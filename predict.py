...
def build_full_trilingual_response(specialty, test_results):
    """
    Builds the complete trilingual response block: specialty name,
    doctor recommendation, overall message, and abnormal-value summary —
    all in English, Hindi, and Marathi together.
    """
    specialty_name = SPECIALTY_TRANSLATIONS.get(specialty, {
        "en": specialty, "hi": specialty, "mr": specialty
    })
